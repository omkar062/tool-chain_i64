...
#define __KERNEL_HEADERS__ "/embedded/cubie/build-root/buildroot-2015.05/output/build/linux-headers-4.0.4/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/embedded/cubie/build-root/usr/bin/arm-buildroot-linux-uclibcgnueabihf-"
